      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            />
            <span className="text-2xl font-semibold tracking-tight text-blue-200">
              TastyFund
            </span>
          </Link>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <>
              <Link
                href="/login"
                className="rounded-lg bg-blue-600 px-4 py-1.5 text-sm font-medium text-white hover:bg-blue-600"
              >
                Sign In
              </Link>
              <Link
